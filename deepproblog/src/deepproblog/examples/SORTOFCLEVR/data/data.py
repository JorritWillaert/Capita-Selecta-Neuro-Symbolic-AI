...
# TODO: images in /image_data/train/ (+ test)
# TODO: labels in csv file under /label_data/train.csv (+ test)
...
class Coins(ImageDataset):
    def __init__(
        ...
        with open("{}/label_data/{}.csv".format(path, subset)) as f:
            for line in f:
                lots_of_info_here = [l.strip() for l in line.split(",")] # TODO extract data from csv
                outcome = "loss"
                if c1 == c2:
                    outcome = "win"
