...
Each specified color will have an object located somewhere in the grid, of which the shape can be a rectangle or a circle.
...
\begin{enumerate}
    \item Non-binary - What is the shape of this object \footnote{I.e. the shape will be either a rectangle or a circle.}?
