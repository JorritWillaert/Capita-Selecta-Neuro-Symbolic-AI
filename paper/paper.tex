...
\begin{figure}[H]
    \begin{center}
    %\includegraphics[width=0.3\textwidth]{sample_own_dataset.png} TODO
    \captionsetup{justification=centering}
...
The network based on pure neural predicates is able to recognize the questions quickly, however, seems to experience difficulties when having to decide for the correct answer. This can clearly be seen in the confusion matrix. % TODO add confusion_matrix_pure_NN_6x6_clear_mistakes here
